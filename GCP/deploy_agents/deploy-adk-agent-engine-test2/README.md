...
4. Send a message:
```bash
poetry run deploy-remote --send --resource_id=your-resource-id --session_id=your-session-id --message="Hello world. How are you today?"
```
...
```
adk-test-bot/
├── adk_test_bot/          # Main package directory
│   ├── __init__.py
